...
Image *readPGMFile(const char *fileName) {
	...
	/* save width */
	{
		...
		fv = readPGMFile_loop_1(&i, number, &c, &imageFile);
	...
	/* save height */
	{
		...
		fv = readPGMFile_loop_2(&i, number, &c, &imageFile);
		...
		;
	{
		...
		fv = readPGMFile_loop_3(&i, number, &c, &imageFile);
	...
	//read data
	{
		...
		fv = readPGMFile_loop_4(&i, &image, &j, &value, &imageFile);
...
void writePGMFile(Image *image, const char *fileName) {
	...
	{	 int re_arg_pa1_5 = -1; 
		...
		fv = writePGMFile_loop_5(&i, &image, &j, &output, &maxival, &re_arg_pa1_5);
	...
	fprintf(output, "255\n");
	{
		...
		fv = writePGMFile_loop_6(&i, &image, &j, &value, &maxival, &output);
...
void writePGMFileNegative(Image *image, FILE *output) {
	...
	minival = 1.0;
	{
		...
		fv = writePGMFileNegative_loop_7(&i, &image, &j, &maxival, &minival);
	...
	fprintf(output, "255\n");
	{
		...
		fv = writePGMFileNegative_loop_8(&i, &image, &j, &value, &maxval, &output);
...
ImageRGB *readPPMFile(const char *fileName) {
	...
	/* save width */
	{
		...
		fv = readPPMFile_loop_9(&i, number, &c, &imageFile);
	...
	/* save height */
	{
		...
		fv = readPPMFile_loop_10(&i, number, &c, &imageFile);
		...
		;
	{
		...
		fv = readPPMFile_loop_11(&i, number, &c, &imageFile);
	...
	//read data
	{
		...
		fv = readPPMFile_loop_12(&i, &image, &j, &value, &imageFile);
...
void writePPMFile(ImageRGB *image, const char *fileName) {
	...
	{	 int re_arg_pa1_13 = -1; 
		...
		fv = writePPMFile_loop_13(&i, &image, &j, &output, &maxival, &re_arg_pa1_13);
	...
	fprintf(output, "255\n");
	{
		...
		fv = writePPMFile_loop_14(&i, &image, &j, &value, &maxival, &output);
...
void writePPMFileNegative(ImageRGB *image, FILE *output) {
	...
	minival = 1.0;
	{
		...
		fv = writePPMFileNegative_loop_15(&i, &image, &j, &maxival, &minival);
	...
	fprintf(output, "255\n");
	{
		...
		fv = writePPMFileNegative_loop_16(&i, &image, &j, &value, &maxval, &output);
...
Image *readDATFile(const char *fileName) {
	...
	//read data
	{
		...
		fv = readDATFile_loop_17(&i, &image, &j, &imageFile, &value);
...
void writeDATFile(Image *image, const char *fileName) {
	...
	maxival = 0.0;
	{
		...
		fv = writeDATFile_loop_18(&i, &image, &j, &maxival);
	...
	fprintf(output, "%d\n%d\n", image->height, image->width);
	{
		...
		fv = writeDATFile_loop_19(&i, &image, &j, &value, &maxival, &output);
